object FValeurs: TFValeurs
  ...
  object Feuillets: TPageControl
    ...
    Margins.Right = 6
    Margins.Bottom = 6
    ActivePage = VariabSheet
    Align = alClient
    Images = VirtualImageList1
    TabOrder = 0
    OnChange = FeuilletsChange
    OnChanging = FeuilletsChanging
    ExplicitWidth = 1298
    ExplicitHeight = 1192
    object ParamSheet: TTabSheet
      ...
      object GridParam: TStringGrid
        ...
        TabOrder = 0
        OnDblClick = GridParamDblClick
        OnExit = GridParamExit
        OnGetEditText = GridParamGetEditText
        OnKeyDown = gridVariabKeyDown
        OnKeyPress = gridVariabKeyPress
        OnMouseDown = GridParamMouseDown
        OnMouseMove = GridParamMouseMove
        OnSelectCell = GridParamSelectCell
      end
      object GridParamGlb: TStringGrid
        ...
        TabOrder = 1
        OnDblClick = GridParamGlbDblClick
        OnExit = GridParamGlbExit
        OnGetEditText = GridParamGlbGetEditText
        OnKeyDown = gridVariabKeyDown
        OnKeyPress = GridParamGlbKeyPress
        OnMouseDown = GridParamMouseDown
        OnMouseMove = GridParamMouseMove
        OnSelectCell = GridParamGlbSelectCell
      end
    ...
    object VariabSheet: TTabSheet
      ...
      object gridVariab: TStringGrid
        ...
        PopupMenu = PopupMenuGrid
        TabOrder = 0
        OnDblClick = gridVariabDblClick
        OnDrawCell = gridVariabDrawCell
        OnExit = gridVariabExit
        OnGetEditText = gridVariabGetEditText
        OnKeyDown = gridVariabKeyDown
        OnKeyPress = gridVariabKeyPress
        OnMouseDown = gridVariabMouseDown
      ...
      object ToolBarVariab: TToolBar
        ...
        object DelLinesBtn: TToolButton
          ...
          Caption = 'Sup. ligne'
          ImageIndex = 9
          ImageName = 'DelLineImage'
          Visible = False
          OnClick = DelSelectItemClick
        end
        ...
        object DeltaBtn: TToolButton
          Left = 0
          Top = 88
          Hint = 'Incertitudes|Affiche, si enfonc'#233', l'#39'incertitude des variables'
          Margins.Left = 6
          Margins.Top = 6
          Margins.Right = 6
          Margins.Bottom = 6
        ...
        object UniteSIBtnBis: TToolButton
          Left = 1092
          Top = 88
          Hint = 'Prise en compte des pr'#233'fixes d'#39'unit'#233
          Margins.Left = 6
          Margins.Top = 6
          Margins.Right = 6
          Margins.Bottom = 6
          Caption = 'Pr'#233'fixe SI'
          ImageIndex = 16
          ImageName = 'Item17'
          OnClick = UniteSIBtnClick
        end
      end
    end
    object ExpSheet: TTabSheet
      ...
      object SimulationBox: TGroupBox
        ...
        object NomEdit: TEdit
          ...
          Margins.Bottom = 6
          TabOrder = 0
          OnChange = SimulationChange
          OnExit = NomEditExit
          OnKeyPress = NomEditKeyPress
        end
        ...
        object MiniEdit: TEdit
          ...
          TabOrder = 2
          OnChange = SimulationChange
          OnExit = EditMinMaxExit
          OnKeyPress = EditMinMaxKeyPress
        end
      ...
      object GrandeursPC: TPageControl
        ...
        object ConstanteTabSheet: TTabSheet
          ...
          Margins.Bottom = 6
          Caption = 'Constantes'
          OnEnter = ConstanteTabSheetShow
          OnShow = ConstanteTabSheetShow
          object ListConstanteUniv: TListBox
            ...
            ItemHeight = 36
            TabOrder = 0
            OnClick = ListConstanteUnivClick
            OnMouseMove = ListConstanteUnivMouseMove
          end
        end
        ...
        object GrandeursTS: TTabSheet
          ...
          object ListeGrandeur: TListBox
            ...
            ItemHeight = 36
            TabOrder = 0
            OnClick = ListeGrandeurClick
            OnMouseMove = ListeGrandeurMouseMove
          end
    ...
    object MathSheet: TTabSheet
      ...
      object WebBrowser1: TWebBrowser
        ...
        ExplicitHeight = 1023
        ControlData = {
          4C000000F9420000C33400000000000000000000000000000000000000000000
    ...
    object PythonTS: TTabSheet
      ...
      object PanelSource: TPanel
        ...
        object ListeGrandeurPython: TListBox
          ...
          ItemHeight = 36
          TabOrder = 0
          OnClick = ListeGrandeurPythonClick
        end
  ...
  object PopupMenuExpr: TPopupMenu
    ...
    object ImporterTraitements: TMenuItem
      ...
      OnClick = ImporterTraitementsClick
    end
  ...
  object PopupMenuGrid: TPopupMenu
    ...
    object DeltaItem: TMenuItem
      Caption = 'Afficher incertitudes'
      ImageIndex = 23
      ImageName = 'IncertImage'
      OnClick = DeltaItemClick
    end
    object PrintGridItem: TMenuItem
      Caption = 'Imprimer tableau'
      OnClick = PrintGridItemClick
    end
  ...
  object PythonTimer: TTimer
    Enabled = False
    Interval = 500
    OnTimer = PythonTimerTimer
    Left = 1252
    Top = 812
  end
end
