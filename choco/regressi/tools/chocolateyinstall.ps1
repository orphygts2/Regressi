...
$url        = 'http://regressi.fr/WordPress/wp-zip/regressi-mpeg-setup.msi' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'Regressi*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
