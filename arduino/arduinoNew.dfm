object ArduinoNewForm: TArduinoNewForm
  Left = 0
  Top = 0
  HelpContext = 80
  ...
  object ToolBar: TToolBar
    ...
    object ToolsBtn: TToolButton
      Left = 0
      Top = 0
      Hint = 'Configuration de l'#39'acquisition et de la voie s'#233'rie'
      Margins.Left = 6
      Margins.Top = 6
      Margins.Right = 6
      Margins.Bottom = 6
  ...
  object ClavierPanel: TPanel
    ...
    TabOrder = 2
    ExplicitWidth = 1650
    object ClavierEdit: TLabeledEdit
      Left = 752
      Top = 8
      Width = 242
      Height = 46
      ...
      EditLabel.Caption = 'Grandeur entr'#233'e au clavier : '
      LabelPosition = lpLeft
      TabOrder = 0
      Text = ''
      OnKeyDown = ClavierEditKeyDown
      OnKeyPress = ClavierEditKeyPress
    end
  end
  object Timer: TTimer
    Enabled = False
